...
(function ($, global, shell, exp, resources, undefined) {
    ...
    function getQuickCreateShareMenuItem() {
        return {
            ...
            open: function () {
                ...
                StorageAdminExtension.Actions.renderListOfUsers("#shareUser");
            },
            ok: function (object) {
                ...
                //    return false;
                //}
                console.log("Selected User: ", object.fields['shareUser']); //$('#shareUser').val()
                return StorageAdminExtension.Actions.createStorageShare(
                            object.fields['shareName'],
                            object.fields['shareTotalSpace'],
                            object.fields['shareNetworkSharePath'],
                            object.fields['shareUser']
                        )
    ...
    shell.Namespace.define("StorageAdminExtension.Menu", {
        getQuickCreateShareMenuItem: getQuickCreateShareMenuItem,
        showQuickCreateShare: showQuickCreateShare
    });

})(jQuery, this, Shell, Exp, StorageAdminExtension.Resources);
